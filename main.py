...
def main():
    ...
    quadrilateral_1["area"] = bretschneidersformula.calculate_area(quadrilateral_1["sides"], quadrilateral_1["opposite_angles_degrees"])
    ...
    quadrilateral_2["area"] = bretschneidersformula.calculate_area(quadrilateral_2["sides"], quadrilateral_2["opposite_angles_degrees"])
